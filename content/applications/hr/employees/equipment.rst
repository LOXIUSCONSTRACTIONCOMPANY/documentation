...
Each Kanban card displays the name and model of the equipment on the first line, then the serial
number, and last, the employee's name. Any current maintenance requests appear at the bottom of the
card in a red box.
...
.. note::
   It does not matter what employee is selected, and if they have any equipment assigned to them or
   not. This is only used to get to the :guilabel:`Equipment` list.
...
clicking and dragging an equipment card to the desired employee, to change ownership of the
equipment.
