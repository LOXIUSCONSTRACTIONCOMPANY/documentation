...
- Select the products and quantities, then click :guilabel:`Draft Bill` to return to the vendor
...
Fo an overview of the open vendor bills and their due dates, go to :menuselection:`Accounting -->
