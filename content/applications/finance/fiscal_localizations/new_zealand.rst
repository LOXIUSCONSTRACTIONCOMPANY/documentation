...
.. seealso::
   :doc:`Tax Configuration <../../../applications/finance/accounting/taxes>`
...
Receivable Account** need to be set in the
:menuselection:`Accounting --> Configurations --> Tax Groups`. A notification will prompt the user
to configure the tax groups.
